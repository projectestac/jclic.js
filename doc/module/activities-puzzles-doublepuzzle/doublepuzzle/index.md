...
title: DoublePuzzle
kind: class
longname: module:activities/puzzles/DoublePuzzle.DoublePuzzle
description: "The aim of this class of {@link module:Activity.Activity Activity} is to put in order the shuffled elements of an {@link module:boxes/ActiveBagContent.ActiveBagContent ActiveBagContent} that contains an image, sounds, text... or any other media content. The activity uses two panels: one with the shuffled cells, and other initially empty where this cells must be placed in order."
---
...
<SourceLink href="/source/activities/puzzles/doublepuzzle-js/#L48" label="DoublePuzzle.js:48" />
...
<MemberMeta sourceHref="/source/activities/puzzles/doublepuzzle-js/#L62" sourceLabel="DoublePuzzle.js:62" />
...
<MemberMeta sourceHref="/source/activities/puzzles/doublepuzzle-js/#L71" sourceLabel="DoublePuzzle.js:71" />
...
<MemberMeta sourceHref="/source/activities/puzzles/doublepuzzle-js/#L80" sourceLabel="DoublePuzzle.js:80" />
...
<MemberMeta sourceHref="/source/activities/puzzles/doublepuzzle-js/#L89" sourceLabel="DoublePuzzle.js:89" />
...
_Inherited from `module:activities/puzzles/DoublePuzzle.DoublePuzzle#helpSolutionAllowed`_
...
_Inherited from `module:activities/puzzles/DoublePuzzle.DoublePuzzle#getMinNumActions`_
...
_Inherited from `module:activities/puzzles/DoublePuzzle.DoublePuzzle#hasRandom`_
...
_Inherited from `module:activities/puzzles/DoublePuzzle.DoublePuzzle#shuffleAlways`_
...
<MemberMeta badges="static" sourceHref="/source/activities/puzzles/doublepuzzle-js/#L420" sourceLabel="DoublePuzzle.js:420" />

Panel class associated to this type of activity: [DoublePuzzlePanel](/module/activities-puzzles-doublepuzzle#doublepuzzlepanel)
