---
title: CrossWordPanel
kind: class
longname: module:activities/textGrid/CrossWord.CrossWordPanel
description: The {@link module:Activity.ActivityPanel ActivityPanel} where {@link module:activities/textGrid/CrossWord.CrossWord CrossWord} activities are played.
---
...
<SourceLink href="/source/activities/textgrid/crossword-js/#L110" label="CrossWord.js:110" />
...
<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L126" sourceLabel="CrossWord.js:126" />

Performs miscellaneous cleaning operations

<MemberHeading id="createboxbag" depth="3" name="createBoxBag" sig="createBoxBag(type: string): module:boxes/BoxBag.BoxBag" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L143" sourceLabel="CrossWord.js:143" />

Creates a [BoxBag](/module/boxes-boxbag#boxbag) with a label ("Horizontal" or "Vertical") and an [ActiveBox](/module/boxes-activebox#activebox)\
...
- [`module:boxes/BoxBag.BoxBag`](/module/boxes-boxbag#boxbag)

<MemberHeading id="buildvisualcomponents" depth="3" name="buildVisualComponents" sig="buildVisualComponents()" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L190" sourceLabel="CrossWord.js:190" />

Prepares the visual components of the activity

<MemberHeading id="initactivity" depth="3" name="initActivity" sig="initActivity()" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L230" sourceLabel="CrossWord.js:230" />

Basic initialization procedure

<MemberHeading id="getcurrentscore" depth="3" name="getCurrentScore" sig="getCurrentScore(): number" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L257" sourceLabel="CrossWord.js:257" />
...
<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L268" sourceLabel="CrossWord.js:268" />
...
<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L289" sourceLabel="CrossWord.js:289" />
...
<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L300" sourceLabel="CrossWord.js:300" />
...
<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L327" sourceLabel="CrossWord.js:327" />
...
<MemberHeading id="movecursor" depth="3" name="moveCursor" sig="moveCursor(dx: number, dy: number)" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L404" sourceLabel="CrossWord.js:404" />

Moves the cursor the specified `dx` and `dy` amount (in logical coordinates)

**Parameters**

- `dx` (number) — Amount of cells to horizontally move on
- `dy` (number) — Amount of cells to vertically move on

<MemberHeading id="setcursorat" depth="3" name="setCursorAt" sig="setCursorAt(x: number, y: number)" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L416" sourceLabel="CrossWord.js:416" />
...
<MemberHeading id="cursorposchanged" depth="3" name="cursorPosChanged" sig="cursorPosChanged()" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L424" sourceLabel="CrossWord.js:424" />

Method called when the cursor moves to a different location

<MemberHeading id="writechars" depth="3" name="writeChars" sig="writeChars(txt: string)" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L440" sourceLabel="CrossWord.js:440" />
...
- `txt` (string) — Text to write

<MemberHeading id="setbtnstatus" depth="3" name="setBtnStatus" sig="setBtnStatus()" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L472" sourceLabel="CrossWord.js:472" />
...
_Inherited from `module:activities/textGrid/CrossWord.CrossWordPanel#setBounds`_
...
_Inherited from `module:activities/textGrid/CrossWord.CrossWordPanel#buildVisualComponents`_
...
_Inherited from `module:activities/textGrid/CrossWord.CrossWordPanel#updateContent`_
...
_Inherited from `module:activities/textGrid/CrossWord.CrossWordPanel#initActivity`_
...
_Inherited from `module:activities/textGrid/CrossWord.CrossWordPanel#setDimension`_
...
_Inherited from `module:activities/textGrid/CrossWord.CrossWordPanel#processEvent`_
...
_Inherited from `module:activities/textGrid/CrossWord.CrossWordPanel#clear`_
...
<MemberHeading id="labelwidth" depth="3" name="LABEL_WIDTH" sig="LABEL_WIDTH: number" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L485" sourceLabel="CrossWord.js:485" />

The default width of the 'Horizontal' and 'Vertical' buttons (currently 40 pixels)

<MemberHeading id="grid" depth="3" name="grid" sig="grid: module:boxes/TextGrid.TextGrid" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L490" sourceLabel="CrossWord.js:490" />

The text grid of this ActivityPanel

<MemberHeading id="style" depth="3" name="style" sig="style: module:boxes/BoxBag.BoxBag" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L495" sourceLabel="CrossWord.js:495" />

A BoxBag used to place the across and down clues, and the `toggle direction` button.

<MemberHeading id="numletters" depth="3" name="numLetters" sig="numLetters: number" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L500" sourceLabel="CrossWord.js:500" />

The total number of letters of this cross word

<MemberHeading id="advance" depth="3" name="advance" sig="advance: string" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L507" sourceLabel="CrossWord.js:507" />

Flag indicating the type of automatic advance of the cursor.\
Possible values are: `NO_ADVANCE` (default), 'ADVANCE\_RIGHT' and 'ADVANCE\_DOWN'.\
TODO: Implement 'ADVANCE\_LEFT' for LTR languages

<MemberHeading id="hclue" depth="3" name="hClue" sig="hClue: module:boxes/ActiveBox.ActiveBox" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L512" sourceLabel="CrossWord.js:512" />

The ActiveBox object used to display the 'across' clues

<MemberHeading id="vclue" depth="3" name="vClue" sig="vClue: module:boxes/ActiveBox.ActiveBox" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L517" sourceLabel="CrossWord.js:517" />

The ActiveBox object used to display the 'down' clues

<MemberHeading id="hcluebtn" depth="3" name="hClueBtn" sig="hClueBtn: module:boxes/ActiveBox.ActiveBox" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L522" sourceLabel="CrossWord.js:522" />

Button used to set the advance mode to 'ADVANCE\_RIGHT'

<MemberHeading id="vcluebtn" depth="3" name="vClueBtn" sig="vClueBtn: module:boxes/ActiveBox.ActiveBox" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L527" sourceLabel="CrossWord.js:527" />

Button used to set the advance mode to 'ADVANCE\_BOTTOM'

<MemberHeading id="events" depth="3" name="events" sig="events: Array.<string>" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L533" sourceLabel="CrossWord.js:533" />

Mouse and touch events intercepted by this panel

<MemberHeading id="hicon" depth="3" name="hIcon" sig="hIcon: string" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L539" sourceLabel="CrossWord.js:539" />

Graphic icon for the horizontal direction button, represented as a string containing\
an SVG file codified in base64.

<MemberHeading id="vicon" depth="3" name="vIcon" sig="vIcon: string" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L545" sourceLabel="CrossWord.js:545" />

Graphic icon for the vertical direction button, represented as a string containing\
an SVG file codified in base64.

<MemberHeading id="icosize" depth="3" name="icoSize" sig="icoSize: object" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L550" sourceLabel="CrossWord.js:550" />

Sizes of the icons (currently 36 x 36 pixel)

<MemberHeading id="icobb" depth="3" name="icoBB" sig="icoBB: module:boxes/BoxBase.BoxBase" />

<MemberMeta sourceHref="/source/activities/textgrid/crossword-js/#L555" sourceLabel="CrossWord.js:555" />
...
_Inherited from `module:activities/textGrid/CrossWord.CrossWordPanel#events`_
