---
title: OrderTextPanel
kind: class
longname: module:activities/text/OrderText.OrderTextPanel
description: The {@link module:activities/text/TextActivityBase.TextActivityBasePanel TextActivityBasePanel} where {@link module:activities/text/OrderText.OrderText OrderText} activities are played.
---
...
<SourceLink href="/source/activities/text/ordertext-js/#L97" label="OrderText.js:97" />
...
<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L113" sourceLabel="OrderText.js:113" />

Prepares the text panel

<MemberHeading id="setbounds" depth="3" name="setBounds" sig="setBounds(rect: module:AWT.Rectangle)" />

<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L123" sourceLabel="OrderText.js:123" />
...
<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L155" sourceLabel="OrderText.js:155" />
...
<MemberHeading
  ...
  name="swapTargets"
  sig="swapTargets(
	t1: module:activities/text/TextActivityDocument.TextTarget,
	t2: module:activities/text/TextActivityDocument.TextTarget,
)"
/>

<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L171" sourceLabel="OrderText.js:171" />

Swaps the position of two targets in the document

**Parameters**

- `t1` ([module:activities/text/TextActivityDocument.TextTarget](/module/activities-text-textactivitydocument#texttarget)) — One target
- `t2` ([module:activities/text/TextActivityDocument.TextTarget](/module/activities-text-textactivitydocument#texttarget)) — Another target

<MemberHeading id="initactivity" depth="3" name="initActivity" sig="initActivity()" />

<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L196" sourceLabel="OrderText.js:196" />

Basic initialization procedure

<MemberHeading id="startactivity" depth="3" name="startActivity" sig="startActivity()" />

<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L208" sourceLabel="OrderText.js:208" />
...
<MemberHeading
  ...
  name="shuffleTargets"
  sig="shuffleTargets(
	targets: Array.<module:activities/text/TextActivityDocument.TextTarget>,
	steps: number,
)"
/>

<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L245" sourceLabel="OrderText.js:245" />

Randomly shuffles a set of targets

**Parameters**

- `targets` (Array.\<[module:activities/text/TextActivityDocument.TextTarget](/module/activities-text-textactivitydocument#texttarget)>) — The set of targets to shuffle (can be all\
  document targets or just the targets belonging to the same paragraph, depending on the value of\
  `amongParagraphs` in [Activity](/module/activity#activity).
- `steps` (number) — The number of times to shuffle the elements

<MemberHeading
  id="setcurrenttarget"
  depth="3"
  name="setCurrentTarget"
  sig="setCurrentTarget(
	target: module:activities/text/TextActivityDocument.TextTarget,
)"
/>

<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L267" sourceLabel="OrderText.js:267" />

Sets the current target

**Parameters**

- `target` ([module:activities/text/TextActivityDocument.TextTarget](/module/activities-text-textactivitydocument#texttarget)) — The currently selected target. Can be `null`.

<MemberHeading id="countsolvedtargets" depth="3" name="countSolvedTargets" sig="countSolvedTargets(): number" />

<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L284" sourceLabel="OrderText.js:284" />
...
<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L293" sourceLabel="OrderText.js:293" />
...
<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L321" sourceLabel="OrderText.js:321" />
...
<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L333" sourceLabel="OrderText.js:333" />
...
_Inherited from `module:activities/text/OrderText.OrderTextPanel#$createTargetElement`_
...
_Inherited from `module:activities/text/OrderText.OrderTextPanel#initActivity`_
...
_Inherited from `module:activities/text/OrderText.OrderTextPanel#startActivity`_

**Overrides:&#x20;**`module:activities/text/TextActivityBase.TextActivityBasePanel#startActivity`
...
_Inherited from `module:activities/text/OrderText.OrderTextPanel#evaluatePanel`_
...
_Inherited from `module:activities/text/OrderText.OrderTextPanel#finishActivity`_
...
_Inherited from `module:activities/text/OrderText.OrderTextPanel#processEvent`_
...
<MemberHeading id="currenttarget" depth="3" name="currentTarget" sig="currentTarget: module:activities/text/TextActivityDocument.TextActivityDocument.TextTarget" />

<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L401" sourceLabel="OrderText.js:401" />

Currently selected text target

<MemberHeading id="bc" depth="3" name="bc" sig="bc: module:boxes/BoxConnector.BoxConnector" />

<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L406" sourceLabel="OrderText.js:406" />
...
<MemberMeta sourceHref="/source/activities/text/ordertext-js/#L412" sourceLabel="OrderText.js:412" />
