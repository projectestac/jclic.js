---
title: WrittenAnswerPanel
kind: class
longname: module:activities/text/WrittenAnswer.WrittenAnswerPanel
description: The {@link module:Activity.ActivityPanel ActivityPanel} where {@link module:activities/text/WrittenAnswer.WrittenAnswer WrittenAnswer} activities are played.
---
...
<SourceLink href="/source/activities/text/writtenanswer-js/#L125" label="WrittenAnswer.js:125" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L141" sourceLabel="WrittenAnswer.js:141" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L156" sourceLabel="WrittenAnswer.js:156" />

Prepares the visual components of the activity

<MemberHeading id="initactivity" depth="3" name="initActivity" sig="initActivity()" />

<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L246" sourceLabel="WrittenAnswer.js:246" />

Basic initialization procedure

<MemberHeading id="activityready" depth="3" name="activityReady" sig="activityReady()" />

<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L272" sourceLabel="WrittenAnswer.js:272" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L284" sourceLabel="WrittenAnswer.js:284" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L304" sourceLabel="WrittenAnswer.js:304" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L315" sourceLabel="WrittenAnswer.js:315" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L368" sourceLabel="WrittenAnswer.js:368" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L381" sourceLabel="WrittenAnswer.js:381" />
...
<MemberHeading id="setcurrentcell" depth="3" name="setCurrentCell" sig="setCurrentCell(i: number, delayedActions: Array.<function()>)" />

<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L390" sourceLabel="WrittenAnswer.js:390" />

Updates the currently selected cell, evaluating the answer written by the user on the text field.

**Parameters**

- `i` (number) — Index into the `ActiveBoxBag` of the cell to make active
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L480" sourceLabel="WrittenAnswer.js:480" />
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswerPanel#setBounds`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswerPanel#buildVisualComponents`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswerPanel#updateContent`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswerPanel#initActivity`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswerPanel#activityReady`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswerPanel#setDimension`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswerPanel#processEvent`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswerPanel#buildAccessibleComponents`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswerPanel#clear`_
...
<MemberHeading id="textfield" depth="3" name="$textField" sig="$textField: external:jQuery" />

<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L524" sourceLabel="WrittenAnswer.js:524" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L529" sourceLabel="WrittenAnswer.js:529" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L534" sourceLabel="WrittenAnswer.js:534" />

The `ActiveBoxBag` object containing the questions

<MemberHeading id="bgb" depth="3" name="bgB" sig="bgB: module:boxes/ActiveBoxBag.ActiveBoxBag" />

<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L539" sourceLabel="WrittenAnswer.js:539" />

An optional `ActiveBoxBag` with content displayed as cells are solved.

<MemberHeading id="currentcell" depth="3" name="currentCell" sig="currentCell: number" />

<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L544" sourceLabel="WrittenAnswer.js:544" />

The currently selected cell

<MemberHeading id="events" depth="3" name="events" sig="events: Array.<string>" />

<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L550" sourceLabel="WrittenAnswer.js:550" />
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswerPanel#events`_
