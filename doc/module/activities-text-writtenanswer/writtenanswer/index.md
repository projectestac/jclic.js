...
title: WrittenAnswer
kind: class
longname: module:activities/text/WrittenAnswer.WrittenAnswer
description: This class of {@link module:Activity.Activity Activity} shows a panel with {@link module:boxes/ActiveBox.ActiveBox ActiveBox} objects acting as cells with questions. The answers to these questions must be written in a separate text field. The ActiveBox objects are filled with data stored in {@link module:boxes/ActiveBagContent.ActiveBagContent ActiveBagContent} repositories. A second {@link module:boxes/ActiveBagContent.ActiveBagContent ActiveBagContent} can be used as alternative content, revealed as the questions are solved.
---
...
<SourceLink href="/source/activities/text/writtenanswer-js/#L50" label="WrittenAnswer.js:50" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L64" sourceLabel="WrittenAnswer.js:64" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L74" sourceLabel="WrittenAnswer.js:74" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L85" sourceLabel="WrittenAnswer.js:85" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L94" sourceLabel="WrittenAnswer.js:94" />
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L103" sourceLabel="WrittenAnswer.js:103" />
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswer#setProperties`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswer#helpSolutionAllowed`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswer#getMinNumActions`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswer#hasRandom`_
...
_Inherited from `module:activities/text/WrittenAnswer.WrittenAnswer#needsKeyboard`_
...
<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L113" sourceLabel="WrittenAnswer.js:113" />

Number of unassigned cells

<MemberHeading id="useidass" depth="3" name="useIdAss" sig="useIdAss: boolean" />

<MemberMeta sourceHref="/source/activities/text/writtenanswer-js/#L118" sourceLabel="WrittenAnswer.js:118" />
...
<MemberMeta badges="static" sourceHref="/source/activities/text/writtenanswer-js/#L556" sourceLabel="WrittenAnswer.js:556" />

Panel class associated to this type of activity: [WrittenAnswerPanel](/module/activities-text-writtenanswer#writtenanswerpanel)
