...
title: ActiveBoxGrid
kind: class
longname: module:boxes/ActiveBoxGrid.ActiveBoxGrid
description: This class extends {@link module:boxes/ActiveBoxbag.ActiveBoxBag ActiveBoxBag} with constructors that take an argument of type {@link module:shapers/Shaper.Shaper Shaper} used to build all its {@link module:boxes/ActiveBox.ActiveBox ActiveBox}components. It also maintains information about the number of &quot;rows&quot; and &quot;columns&quot;, useful to compute valid (integer) values when resizing or moving its components.
---

# ActiveBoxGrid

**Extends:&#x20;**[`module:boxes/ActiveBoxBag.ActiveBoxBag`](/module/boxes-activeboxbag#activeboxbag)

<SourceLink href="/source/boxes/activeboxgrid-js/#L44" label="ActiveBoxGrid.js:44" />
...
<MemberMeta sourceHref="/source/boxes/activeboxgrid-js/#L122" sourceLabel="ActiveBoxGrid.js:122" />
...
<MemberMeta sourceHref="/source/boxes/activeboxgrid-js/#L133" sourceLabel="ActiveBoxGrid.js:133" />
...
<MemberHeading id="getcoord" depth="3" name="getCoord" sig="getCoord(bx: module:boxes/ActiveBox.ActiveBox): module:AWT.Point" />

<MemberMeta sourceHref="/source/boxes/activeboxgrid-js/#L146" sourceLabel="ActiveBoxGrid.js:146" />

Returns the logical coordinates of the provided [ActiveBox](/module/boxes-activebox#activebox).\
The units of the result are not pixels, but ordinal numbers (relative positions) of columns\
and rows in the grid.

**Parameters**

- `bx` ([module:boxes/ActiveBox.ActiveBox](/module/boxes-activebox#activebox)) — The box to process
...
<MemberMeta sourceHref="/source/boxes/activeboxgrid-js/#L158" sourceLabel="ActiveBoxGrid.js:158" />

Calculates the logical distance between two [ActiveBox](/module/boxes-activebox#activebox) objects.\
Resulting units are not pixels, but ordinal numbers (relative positions) of columns and rows\
in the grid.

**Parameters**

- `src` ([module:boxes/ActiveBox.ActiveBox](/module/boxes-activebox#activebox)) — First box
- `dest` ([module:boxes/ActiveBox.ActiveBox](/module/boxes-activebox#activebox)) — Second box
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#addActiveBox`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#getActiveBox`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#getBackgroundActiveBox`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#setContent`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#findActiveBox`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#clearAllBoxes`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#clearAll`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#countCellsAtPlace`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#getActiveBoxWithIdLoc`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#cellIsAtEquivalentPlace`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#countCellsAtEquivalentPlace`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#countCellsWithIdAss`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#setDefaultIdAss`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#shuffleCells`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#fitCellsInArea`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#swapCellPositions`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#resetIds`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#getNextItem`_
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#buildAccessibleElements`_
...
<MemberMeta badges="static" sourceHref="/source/boxes/activeboxgrid-js/#L105" sourceLabel="ActiveBoxGrid.js:105" />

This factory constructor creates a new empty grid with the number of cells indicated by the\
[ActiveBagContent](/module/boxes-activebagcontent#activebagcontent) `abc`, not filling the cells with any content.
...
- `px` (number) — `X` coordinate of the upper left corner of this box grid
- `py` (number) — `Y` coordinate of the upper left corner of this box grid
- `abc` ([module:boxes/ActiveBagContent.ActiveBagContent](/module/boxes-activebagcontent#activebagcontent)) — Used only to get the number of cells and the shaper (when `sh` is `null`)
- `sh` ([module:shapers/Shaper.Shaper](/module/shapers-shaper#shaper)) — Shaper used to build the ActiveBox objects
...
- [`module:boxes/ActiveBoxGrid.ActiveBoxGrid`](/module/boxes-activeboxgrid#activeboxgrid)
...
<MemberMeta sourceHref="/source/boxes/activeboxgrid-js/#L171" sourceLabel="ActiveBoxGrid.js:171" />

Number of columns of this box grid

<MemberHeading id="nrows" depth="3" name="nRows" sig="nRows: number" />

<MemberMeta sourceHref="/source/boxes/activeboxgrid-js/#L176" sourceLabel="ActiveBoxGrid.js:176" />
...
_Inherited from `module:boxes/ActiveBoxBag.ActiveBoxBag#$accessibleDiv`_
