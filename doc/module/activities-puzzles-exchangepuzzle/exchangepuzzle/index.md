---
title: ExchangePuzzle
kind: class
longname: module:activities/puzzles/ExchangePuzzle.ExchangePuzzle
description: This class of {@link module:Activity.Activity Activity} shows only one panel with shuffled {@link module:boxes/ActiveBox.ActiveBox ActiveBox} objects. To solve the activity, each cell must exchange its location with another one. When all cells are on place, the activity is done.
---
...
<SourceLink href="/source/activities/puzzles/exchangepuzzle-js/#L45" label="ExchangePuzzle.js:45" />
...
<MemberMeta sourceHref="/source/activities/puzzles/exchangepuzzle-js/#L59" sourceLabel="ExchangePuzzle.js:59" />
...
<MemberMeta sourceHref="/source/activities/puzzles/exchangepuzzle-js/#L68" sourceLabel="ExchangePuzzle.js:68" />
...
<MemberMeta sourceHref="/source/activities/puzzles/exchangepuzzle-js/#L77" sourceLabel="ExchangePuzzle.js:77" />
...
<MemberMeta sourceHref="/source/activities/puzzles/exchangepuzzle-js/#L86" sourceLabel="ExchangePuzzle.js:86" />
...
_Inherited from `module:activities/puzzles/ExchangePuzzle.ExchangePuzzle#helpSolutionAllowed`_
...
_Inherited from `module:activities/puzzles/ExchangePuzzle.ExchangePuzzle#getMinNumActions`_
...
_Inherited from `module:activities/puzzles/ExchangePuzzle.ExchangePuzzle#hasRandom`_
...
_Inherited from `module:activities/puzzles/ExchangePuzzle.ExchangePuzzle#shuffleAlways`_
...
<MemberMeta badges="static" sourceHref="/source/activities/puzzles/exchangepuzzle-js/#L371" sourceLabel="ExchangePuzzle.js:371" />

Panel class associated to this type of activity: `ExchangePuzzlePanel`
