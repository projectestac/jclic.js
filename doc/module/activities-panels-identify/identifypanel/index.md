...
title: IdentifyPanel
kind: class
longname: module:activities/panels/Identify.IdentifyPanel
description: The {@link module:Activity.ActivityPanel ActivityPanel} where {@link module:activities/panels/Identify.Identify Identify} activities are played.
---
...
<SourceLink href="/source/activities/panels/identify-js/#L89" label="Identify.js:89" />
...
<MemberMeta sourceHref="/source/activities/panels/identify-js/#L105" sourceLabel="Identify.js:105" />

Miscellaneous cleaning operations

<MemberHeading id="buildvisualcomponents" depth="3" name="buildVisualComponents" sig="buildVisualComponents()" />

<MemberMeta sourceHref="/source/activities/panels/identify-js/#L116" sourceLabel="Identify.js:116" />

Prepares the visual components of the activity

<MemberHeading id="initactivity" depth="3" name="initActivity" sig="initActivity()" />

<MemberMeta sourceHref="/source/activities/panels/identify-js/#L176" sourceLabel="Identify.js:176" />

Basic initialization procedure

<MemberHeading id="updatecontent" depth="3" name="updateContent" sig="updateContent(dirtyRegion: module:AWT.Rectangle)" />

<MemberMeta sourceHref="/source/activities/panels/identify-js/#L203" sourceLabel="Identify.js:203" />
...
<MemberMeta sourceHref="/source/activities/panels/identify-js/#L224" sourceLabel="Identify.js:224" />
...
<MemberMeta sourceHref="/source/activities/panels/identify-js/#L235" sourceLabel="Identify.js:235" />
...
<MemberMeta sourceHref="/source/activities/panels/identify-js/#L269" sourceLabel="Identify.js:269" />
...
<MemberMeta sourceHref="/source/activities/panels/identify-js/#L283" sourceLabel="Identify.js:283" />
...
_Inherited from `module:activities/panels/Identify.IdentifyPanel#setBounds`_
...
_Inherited from `module:activities/panels/Identify.IdentifyPanel#buildVisualComponents`_
...
_Inherited from `module:activities/panels/Identify.IdentifyPanel#updateContent`_
...
_Inherited from `module:activities/panels/Identify.IdentifyPanel#initActivity`_
...
_Inherited from `module:activities/panels/Identify.IdentifyPanel#setDimension`_
...
_Inherited from `module:activities/panels/Identify.IdentifyPanel#processEvent`_
...
_Inherited from `module:activities/panels/Identify.IdentifyPanel#buildAccessibleComponents`_
...
_Inherited from `module:activities/panels/Identify.IdentifyPanel#clear`_
...
<MemberMeta sourceHref="/source/activities/panels/identify-js/#L339" sourceLabel="Identify.js:339" />

The `ActiveBoxBag` containing the information to be displayed on the panel.

<MemberHeading id="events" depth="3" name="events" sig="events: Array.<string>" />

<MemberMeta sourceHref="/source/activities/panels/identify-js/#L345" sourceLabel="Identify.js:345" />
...
_Inherited from `module:activities/panels/Identify.IdentifyPanel#events`_
