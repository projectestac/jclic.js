...
title: Identify
kind: class
longname: module:activities/panels/Identify.Identify
description: The aim of this type of {@link module:Activity.Activity Activity} is to identify {@link module:boxes/ActiveBox.ActiveBox ActiveBox} elements in a panel that satisfy a specific condition, usually exposed in the main message.
---
...
<SourceLink href="/source/activities/panels/identify-js/#L43" label="Identify.js:43" />
...
<MemberMeta sourceHref="/source/activities/panels/identify-js/#L57" sourceLabel="Identify.js:57" />
...
<MemberMeta sourceHref="/source/activities/panels/identify-js/#L66" sourceLabel="Identify.js:66" />
...
_Inherited from `module:activities/panels/Identify.Identify#getMinNumActions`_
...
_Inherited from `module:activities/panels/Identify.Identify#hasRandom`_
...
<MemberMeta sourceHref="/source/activities/panels/identify-js/#L76" sourceLabel="Identify.js:76" />

Number of not assigned cells (calculated in [buildVisualComponents](/module/activities-panels-identify/identifypanel#buildvisualcomponents))

<MemberHeading id="cellstomatch" depth="3" name="cellsToMatch" sig="cellsToMatch: number" />

<MemberMeta sourceHref="/source/activities/panels/identify-js/#L82" sourceLabel="Identify.js:82" />

Number of cells the user must identify to complete the activity (calculated in\
[buildVisualComponents](/module/activities-panels-identify/identifypanel#buildvisualcomponents))
...
<MemberMeta badges="static" sourceHref="/source/activities/panels/identify-js/#L351" sourceLabel="Identify.js:351" />

Panel class associated to this type of activity: [IdentifyPanel](/module/activities-panels-identify#identifypanel)
