...
title: JigSaw
kind: class
longname: module:shapers/JigSaw.JigSaw
description: This {@link module:shapers/Shaper.Shaper Shaper} returns a set of rectangular shapes with teeth and slots that fit between them.
---
...
<SourceLink href="/source/shapers/jigsaw-js/#L40" label="JigSaw.js:40" />

This [Shaper](/module/shapers-shaper#shaper) returns a set of rectangular shapes with teeth and slots that fit between them.

---

## Constructor

<Signature code="new JigSaw(nx: number, ny: number): JigSaw" />
...
<MemberMeta sourceHref="/source/shapers/jigsaw-js/#L102" sourceLabel="JigSaw.js:102" />
...
<MemberMeta sourceHref="/source/shapers/jigsaw-js/#L136" sourceLabel="JigSaw.js:136" />
