...
title: EmptySkin
kind: class
longname: module:skins/EmptySkin.EmptySkin
description: A minimalist {@link module:skins/Skin.Skin Skin} for JClic.js with just the player, without messages, counters nor any button.
---
...
<SourceLink href="/source/skins/emptyskin-js/#L39" label="EmptySkin.js:39" />

A minimalist [Skin](/module/skins-skin#skin) for JClic.js with just the player, without messages, counters nor any button.
...
<MemberMeta sourceHref="/source/skins/emptyskin-js/#L61" sourceLabel="EmptySkin.js:61" />
...
_Inherited from `module:skins/Skin.Skin#enableMainButtons`_
...
<MemberMeta sourceHref="/source/skins/emptyskin-js/#L72" sourceLabel="EmptySkin.js:72" />

Class name of this skin. It will be used as a base selector in the definition of all CSS styles.

<MemberHeading id="skincss" depth="3" name="skinCSS" sig="skinCSS: string" />

<MemberMeta sourceHref="/source/skins/emptyskin-js/#L78" sourceLabel="EmptySkin.js:78" />
...
_Inherited from `module:skins/EmptySkin.EmptySkin#skinId`_
