...
title: FillInBlanks
kind: class
longname: module:activities/text/FillInBlanks.FillInBlanks
description: In this type of activity the text document has some blanks that must be filled-in. The blanks can be drop-down boxes or text fields (empty or pre-filled with an initial text). Blanks can also have associated clues, shown as &quot;pop-ups&quot;.
---

# FillInBlanks

**Extends:&#x20;**[`module:activities/text/TextActivityBase.TextActivityBase`](/module/activities-text-textactivitybase#textactivitybase)

<SourceLink href="/source/activities/text/fillinblanks-js/#L43" label="FillInBlanks.js:43" />
...
<MemberMeta sourceHref="/source/activities/text/fillinblanks-js/#L57" sourceLabel="FillInBlanks.js:57" />
...
<MemberMeta sourceHref="/source/activities/text/textactivitybase-js/#L57" sourceLabel="TextActivityBase.js:57" />

_Inherited from `module:activities/text/TextActivityBase.TextActivityBase#getMinNumActions`_
...
_Inherited from `module:Activity.Activity#helpSolutionAllowed`_
...
_Inherited from `module:Activity.Activity#hasRandom`_
...
_Inherited from `module:Activity.Activity#shuffleAlways`_
...
<MemberHeading id="autojump" depth="3" name="autoJump" sig="autoJump: boolean" />

<MemberMeta sourceHref="/source/activities/text/fillinblanks-js/#L67" sourceLabel="FillInBlanks.js:67" />

Whether to jump or not to the next target when the current one is solved.

<MemberHeading id="forceoktoadvance" depth="3" name="forceOkToAdvance" sig="forceOkToAdvance: boolean" />

<MemberMeta sourceHref="/source/activities/text/fillinblanks-js/#L73" sourceLabel="FillInBlanks.js:73" />

Whether to block or not the jump to other targets until the current one\
is resolved.

<MemberHeading id="ev" depth="3" name="ev" sig="ev: module:activities/text/Evaluator.Evaluator" />

<MemberMeta sourceHref="/source/activities/text/textactivitybase-js/#L67" sourceLabel="TextActivityBase.js:67" />

_Inherited from `module:activities/text/TextActivityBase.TextActivityBase#ev`_
...
<MemberHeading id="checkbuttontext" depth="3" name="checkButtonText" sig="checkButtonText: string" />

<MemberMeta sourceHref="/source/activities/text/textactivitybase-js/#L72" sourceLabel="TextActivityBase.js:72" />

_Inherited from `module:activities/text/TextActivityBase.TextActivityBase#checkButtonText`_
...
<MemberHeading id="prevscreen" depth="3" name="prevScreen" sig="prevScreen: boolean" />

<MemberMeta sourceHref="/source/activities/text/textactivitybase-js/#L77" sourceLabel="TextActivityBase.js:77" />

_Inherited from `module:activities/text/TextActivityBase.TextActivityBase#prevScreen`_
...
<MemberHeading id="prevscreentext" depth="3" name="prevScreenText" sig="prevScreenText: string" />

<MemberMeta sourceHref="/source/activities/text/textactivitybase-js/#L83" sourceLabel="TextActivityBase.js:83" />

_Inherited from `module:activities/text/TextActivityBase.TextActivityBase#prevScreenText`_
...
<MemberHeading id="prevscreenstyle" depth="3" name="prevScreenStyle" sig="prevScreenStyle: module:boxes/BoxBase.BoxBase" />

<MemberMeta sourceHref="/source/activities/text/textactivitybase-js/#L88" sourceLabel="TextActivityBase.js:88" />

_Inherited from `module:activities/text/TextActivityBase.TextActivityBase#prevScreenStyle`_
...
<MemberHeading id="prevscreenmaxtime" depth="3" name="prevScreenMaxTime" sig="prevScreenMaxTime: number" />

<MemberMeta sourceHref="/source/activities/text/textactivitybase-js/#L93" sourceLabel="TextActivityBase.js:93" />

_Inherited from `module:activities/text/TextActivityBase.TextActivityBase#prevScreenMaxTime`_
...
<MemberMeta badges="static" sourceHref="/source/activities/text/fillinblanks-js/#L423" sourceLabel="FillInBlanks.js:423" />

Panel class associated to this type of activity: [FillInBlanksPanel](/module/activities-text-fillinblanks#fillinblankspanel)
