...
define([
  ...
  OrangeSkin.prototype = {
    ...
    resources: {
      ...
      thisCSS: '.SKINID {background-color:#FF8B19;}'
    }
  };
  // Inherit Skin resources prior to merge prototypes
  var resources = $.extend(Object.create(DefaultSkin.prototype.resources), OrangeSkin.prototype.resources);
  // DefaultSkin extends [Skin](Skin.html)
  OrangeSkin.prototype = $.extend(Object.create(DefaultSkin.prototype), OrangeSkin.prototype);
  // Set resources
  OrangeSkin.prototype.resources = resources;
