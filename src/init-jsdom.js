...
// These imports will be avoided in browser builds. See "browser" section in package.json.
...
// Define global properties only when building for NodeJS
if (!globalObject.window) {
  ...
  const dom = new JSDOM('<!DOCTYPE html><head></head><body></body>', { url: 'https://example.com' });
