...
// <%= pkg.homepage %>\n'
    ...
    //
    // Check source code for possible inconsistencies or syntax errors with ESLint
    eslint: {
      src: ['src/**/*.js', '!src/GlobalData.js'],
      options: {
  ...
  grunt.registerTask(
          ...
          ['eslint', 'locales', 'clean:dist', 'browserify:dist', 'extract_sourcemap:dist', 'uglify:dist']);
